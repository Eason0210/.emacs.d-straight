...
(use-package ibuffer-vc :straight t :defer t)
...
(use-package magit
  ...
  (magit-no-confirm '(amend-published))
...
(use-package project
  :defer t
  :custom
  (project-find-functions '(project-try-local project-try-vc))
  :config
  (defun project-try-local (dir)
    "Determine if DIR is a non-Git project."
    (catch 'ret
      (let ((pr-flags '((".project")
                        ("Cargo.toml" "pom.xml" "package.json")
  ...
  (defun project-add-dot-project-file ()
    (interactive)
...
(use-package cmake-mode :straight t :defer t)
...
(use-package mscl-mode
  :straight (:host github :repo "Eason0210/mscl-mode"))
...
(use-package super-save
  ...
  :defer 0.5
  :custom
  (super-save-max-buffer-size 200000)
